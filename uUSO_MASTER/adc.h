...
struct ADC_Channels	   //структура значений и настройки канала ј÷ѕ
{
	...
	unsigned char adc_buf_counter;//счетчик буфера усреднени€
	unsigned char ADC_SF;//значение SINC-фильтра текущего канала
	unsigned char ADC_GAIN;//значение усилени€ текущего канала
	unsigned char buffered;//флаг буферизации канала
	unsigned char unipolar;//флаг унипол€рный/бипол€рный канал
...
unsigned long Meaning(unsigned long mas[],unsigned char size);//находим матожидание по циклическому массиву усреднени€
